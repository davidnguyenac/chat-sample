...
var ChatSupportContext = React.createContext(undefined);
var initialValue = {
    isOpen: false,
};
var IntercomChatSupportProvider = function (_a) {
    var children = _a.children;
    var _b = React.useReducer(chatSupportReducer, initialValue), states = _b[0], dispatch = _b[1];
...
var SampleComponent = function (_a) {
    _a.label;
    var _b = React.useState(false), isAuth = _b[0], setIsAuth = _b[1];
